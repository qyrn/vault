...
export const BUILTIN: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Blog', url: 'https://blog.qyrn.dev', desc: 'Mon blog cybersécurité', tag: 'Perso', difficulty: null },
      { name: 'Pentesting Journey', url: 'https://github.com/qyrn/pentesting-journey', desc: 'Mon parcours et notes de pentesting', tag: 'Perso', difficulty: null },
